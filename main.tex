...
\noindent {\textbf{E-mail: contact@fim4r.org} \\  \\ For the ORCID{\textsuperscript{\textregistered}} identifiers and author affiliations of the ``Federated Identity Management for Research" collaboration to their various Research Communities and e-Infrastructures, see Appendix \ref{appendix:authors}}
\newline
\newline

\noindent {\textbf{Document details} - Version: 2.0.  Date: 22 June 2018 \\ doi: 10.5281/zenodo.1296032 }
\newline
